...
/**
 * Budget table presenter component
 *
 * NOTE: This component uses Angular Signal Inputs (Angular 17.1+)
 * Current project version: Angular 15.0.4
 * This code will not compile without upgrading to Angular 17.1+
 */
@Component({
